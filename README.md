...
|   包名             |    简介                  |               翻译人                      |  状态  |   起始时间  | 预期结束时间 | 实际结束时间  |    校验人  |
|-------------------|--------------------------|------------------------------------------|-------|------------|------------|-------------|------------|
|[archive/tar]()|tar包实现了访问tar归档文件的方法。| [@jemygraw](https://github.com/jemygraw) | 已翻译 | 2014/07/16 | 2014/07/16 |2014/07/16   |            |
|[archive/zip]()|zip包提供了读写zip归档文件的功能。| [@jemygraw](https://github.com/jemygraw) | 已占用 | 2014/07/21 | 2014/07/22 |             |            |
|[bufio]()|||||||||
|[builtin]()|||||||||
|[bytes]()|||||||||
|[compress/bzip2]()||||||||
